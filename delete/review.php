...
<body>
    <center_content class="anim_elem faded_elem" data-to="faded_elem" data-tc="faded_elem">
        <div class="fast_buttons">
            <!-- Назад -->
            <a href="../reviews?id=<? echo $template_id ?>"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19 12H5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12 19L5 12L12 5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg></a> 
        </div>
        <h3 class="subtitle center">Удалить отзыв?</h3>
        <p class="simple_text">Вы действительно хотите удалить отзыв?</p>
        <p class="simple_text">Для подтверждения нажмите "<span class="important">Удалить</span>"</p>
        <a href="review_system.php?id=<? echo $template_id ?>&review=<? echo $review_id ?>" class="button">
