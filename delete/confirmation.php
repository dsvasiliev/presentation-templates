<?php
    ...
    if(is_logined()) header('Refresh: 0; url=index.php');
?>
<body>
    <center_content class="anim_elem faded_elem" data-to="faded_elem" data-tc="faded_elem">
        ...
        <h3 class="subtitle center">Удалить аккаунт?</h3>
        <p class="simple_text">Вы действительно хотите удалить аккаунт с нашей платформы?</p>
        <p class="simple_text">Все ваши работы <span class="important">сохраняться</span> в общем доступе после удаления аккаунта, однако восстановить доступ к ним будет уже невозможно</p>
        <a href="../user_functions/exit&delete_system" class="button">
